        ...
        <div class="max-w-2xl mx-auto px-4 py-5">
            ...
            <div v-if="mode === 'quick'">
                ...
                <div v-if="confirmAction"
                    ...
                    <div class="flex justify-between items-center mb-4">
                        <span class="text-[13px] text-[#1A2E2B]/70">
                            {{ translateActionLabel(confirmAction.label) }}
                        </span>
                ...
                <div v-else>
                    ...
                    <div class="grid grid-cols-2 gap-3 mb-4">
                        <button v-for="action in quickActions"
                            ...
                            <p class="text-[13px] font-semibold text-[#1A2E2B] mb-1">
            ...
            <div v-if="mode === 'manual'" class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <button @click="form.direction = 'out'; form.category_id = null"
                    ...
                    <button @click="form.direction = 'in'; form.category_id = null"
                            class="py-3.5 rounded-2xl border-[1.5px] text-[13px] font-semibold transition-all"
